...
<body>
    <form id="form1" runat="server">
         <div align="Center" style="background-color: #011627; height: 1000px;">
             <header style="color:aliceblue; font-size: 50px">Register</header>
            <div>
            <br />
                 <table align="Center" class="auto-style4" style="font-family: Arial; color: #2EC4B6; background-color: #011627; border: 2px solid #FDFFFC;">       
                    <tr>
                    <td>
                        Student Number<span style="color:#E71D36">*</span>
                    </td>
                    <td>
                        <asp:TextBox ID="StudentId" runat="server" Width="200px" TextMode="SingleLine" MaxLength="15"></asp:TextBox>
                    </td>
                    <td class="auto-style1"> 
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter a Student Number" ControlToValidate="FirstName" Text="Please enter a first name" ForeColor="#E71D36"></asp:RequiredFieldValidator>
                    </td>
                    </tr>
                    <tr>
                    <td>
        ...
        <br />
        <asp:Button ID="Save" runat="server" Text="Save" OnClick="OnSave_Click" />
       </div>
    </form>
</body>
</html>
